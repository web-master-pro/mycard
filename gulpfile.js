...
gulp.task('js', ['js:jquery','js:plugins','js:app','js:header']);
...
gulp.task('watch', function (cb) {
    ...
    watch(["src/js/header.js"], function(event, cb) {
        runSequence('js:header', browserSync.reload);
        notify("JS Header").write('');
    });
...
gulp.task('build', function (cb) {
    return runSequence(
        'clean',
        ['sprite', 'img', 'video', 'favicons', 'fonts', 'php', 'js'],
        ['style'],
        'html:fs', cb);
});
